...
export interface ApiQuestionQuestion extends Schema.CollectionType {
  ...
  attributes: {
    ...
    triviaGame: Attribute.Relation<
      'api::question.question',
      'manyToOne',
      'api::trivia-game.trivia-game'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    memoryGames: Attribute.Relation<
      'api::tag.tag',
      'manyToMany',
      'api::memory-game.memory-game'
    >;
    triviaGames: Attribute.Relation<
      'api::tag.tag',
      'manyToMany',
      'api::trivia-game.trivia-game'
    >;
...
export interface ApiTriviaGameTriviaGame extends Schema.CollectionType {
